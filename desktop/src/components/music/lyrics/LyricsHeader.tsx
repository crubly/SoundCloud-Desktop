...
export const LyricsHeader = React.memo(
  ({ tab, rightPanelOpen, onSelectTab, onTogglePanel, onClose }: LyricsHeaderProps) => {
    ...
    return (
      ...
      >
        {/* centred tabs */}
        <div className="absolute left-1/2 -translate-x-1/2 pointer-events-auto inline-flex items-center gap-1 rounded-full border border-white/[0.08] bg-black/35 backdrop-blur-xl p-1 shadow-[0_8px_30px_rgba(0,0,0,0.35)]">
          <TabButton

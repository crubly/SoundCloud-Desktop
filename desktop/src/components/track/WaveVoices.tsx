  ...
  return (
    <div className="absolute inset-0 pointer-events-none z-10">
      {dots.map((d, i) => (
        ...
        >
          <span className="wv-pip block w-[7px] h-[7px] -translate-x-1/2 rounded-full bg-accent shadow-[0_0_8px_var(--color-accent-glow)] transition-transform duration-200 group-hover/dot:scale-150" />
          <span
